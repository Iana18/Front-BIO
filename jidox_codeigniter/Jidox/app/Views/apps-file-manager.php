                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="page-aside-left">
                                            ...
                                            <div class="btn-group dropdown-center d-block mb-2">
                                                        ...
                                                        <div class="card m-1 shadow-none border">
                                                            <div class="p-2">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <a href="javascript:void(0);" class="text-muted fw-bold">Admin-sketch.zip</a>
                                                        ...
                                                        <div class="card m-1 shadow-none border">
                                                            <div class="p-2">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col ps-0">
                                                                        <a href="javascript:void(0);" class="text-muted fw-bold">Admin Integrations</a>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-centered table-nowrap table-borderless table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <span class="fw-normal"><a href="javascript: void(0);" class="text-reset">App Design & Development</a></span>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td id="tooltip-container">
                                                                    <div class="avatar-group">
                                                                        <a href="javascript: void(0);" class="avatar-group-item mb-0" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                                                                            <img src="/assets/images/users/avatar-1.jpg" class="rounded-circle avatar-xs shadow-lg" alt="friend">
                                                                        </a>
                                                                        ...
                                                                        <a href="javascript: void(0);" class="avatar-group-item mb-0" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty">
                                                                            <img src="/assets/images/users/avatar-2.jpg" class="rounded-circle avatar-xs shadow-lg" alt="friend">
                                                                        </a>
                                                                        ...
                                                                        <a href="javascript: void(0);" class="avatar-group-item mb-0" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson">
                                                                            <img src="/assets/images/users/avatar-3.jpg" class="rounded-circle avatar-xs shadow-lg" alt="friend">
                                                                        </a>
                                                                        ...
                                                                        <a href="javascript: void(0);" class="avatar-group-item mb-0" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Username">
                                                                            <img src="/assets/images/users/avatar-5.jpg" class="rounded-circle avatar-xs shadow-lg" alt="friend">
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                                <td class="">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span class="fw-normal"><a href="javascript: void(0);" class="text-reset">Admin-sketch-design.zip</a></span>
                                                                </td>
                                                                <td>
                                                                    <p class="mb-0">Feb 13, 2023</p>
                                                                    <span class="fs-12">by mannatthemes</span>
                                                                </td>
                                                                <td>521 MB</td>
                                                                <td>
                                                                    Coder Themes
                                                                ...
                                                                <td id="tooltip-container1">
                                                                    <div class="avatar-group">
                                                                        <a href="javascript: void(0);" class="avatar-group-item mb-0" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                                                                            <img src="/assets/images/users/avatar-4.jpg" class="rounded-circle avatar-xs shadow-lg" alt="friend">
                                                                        </a>
                                                                        ...
                                                                        <a href="javascript: void(0);" class="avatar-group-item mb-0" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson">
                                                                            <img src="/assets/images/users/avatar-6.jpg" class="rounded-circle avatar-xs shadow-lg" alt="friend">
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span class="fw-normal"><a href="javascript: void(0);" class="text-reset">Annualreport.pdf</a></span>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td id="tooltip-container2">
                                                                    <div class="avatar-group">
                                                                        <a href="javascript: void(0);" class="avatar-group-item mb-0" data-bs-container="#tooltip-container2" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                                                                            <img src="/assets/images/users/avatar-9.jpg" class="rounded-circle avatar-xs shadow-lg" alt="friend">
                                                                        </a>
                                                                        ...
                                                                        <a href="javascript: void(0);" class="avatar-group-item mb-0" data-bs-container="#tooltip-container2" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty">
                                                                            <img src="/assets/images/users/avatar-7.jpg" class="rounded-circle avatar-xs shadow-lg" alt="friend">
                                                                        </a>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span class="fw-normal"><a href="javascript: void(0);" class="text-reset">Wireframes</a></span>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td id="tooltip-container3">
                                                                    <div class="avatar-group">
                                                                        ...
                                                                        <a href="javascript: void(0);" class="avatar-group-item mb-0" data-bs-container="#tooltip-container3" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty">
                                                                            <img src="/assets/images/users/avatar-8.jpg" class="rounded-circle avatar-xs shadow-lg" alt="friend">
                                                                        </a>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span class="fw-normal"><a href="javascript: void(0);" class="text-reset">Documentation.docs</a></span>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td id="tooltip-container4">
                                                                    <div class="avatar-group">
                                                                        ...
                                                                        <a href="javascript: void(0);" class="avatar-group-item mb-0" data-bs-container="#tooltip-container4" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty">
                                                                            <img src="/assets/images/users/avatar-10.jpg" class="rounded-circle avatar-xs shadow-lg" alt="friend">
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                                <td>
