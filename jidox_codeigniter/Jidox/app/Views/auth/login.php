...
<div class="position-absolute start-0 end-0 start-0 bottom-0 w-100 h-100">
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"  width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 1920 1024">
            ...
            <div class="col-xxl-4 col-lg-5">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="<?= base_url('loginCheck') ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="email" id="emailaddress" name="email" value="test@test.com" placeholder="Enter your email">
                            </div>

                            <div class="mb-3">
                                <a href="/auth-recoverpw" class="text-muted float-end fs-12">Forgot your password?</a>
                                <label for="password" class="form-label">Password</label>
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control" name="password" value="password" placeholder="Enter your password">
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-white-50">Don't have an account? <a href="/auth-register" class="text-white ms-1 link-offset-3 text-decoration-underline"><b>Sign Up</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
...
<footer class="footer footer-alt">
    <span class="text-white-50"><script>document.write(new Date().getFullYear())</script> © Jidox - mannatthemes.com</span>
</footer>
