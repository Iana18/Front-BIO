...
<head>
    <?php echo view('partials/title-meta', array('title' => 'Layout Fullscreen')) ?>

    <!-- Daterangepicker css -->
    <link rel="stylesheet" href="/assets/libs/daterangepicker/daterangepicker.css">

    <!-- Vector Map css -->
    <link rel="stylesheet" href="/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css">
