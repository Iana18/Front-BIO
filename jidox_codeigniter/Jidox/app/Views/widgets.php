            ...
            <div class="content-page">
                <div class="content">                    
                    ...
                    <div class="container-fluid">
                        ...
                        <?php echo view('partials/page-title', array('subtitle' => 'Extras', 'title' => 'Widgets')) ?>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="flex-grow-1 overflow-hidden">
                                                ...
                                                <p class="mb-0 text-white text-opacity-75 text-truncate">
                                                    <span class="badge bg-white bg-opacity-10 me-1"><i class="ri-arrow-up-line"></i> 2,541</span>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div class="flex-grow-1 overflow-hidden">
                                                ...
                                                <p class="mb-0 text-white text-opacity-75 text-truncate">
                                                    <span class="badge bg-white bg-opacity-25 me-1"><i class="ri-arrow-down-line"></i> 1.08%</span>
                                                    <span>Since last month</span>
                                                </p>
                                            </div>
                                            <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <div class="flex-grow-1 overflow-hidden">
                                                ...
                                                <p class="mb-0 text-white text-opacity-75 text-truncate">
                                                    <span class="badge bg-white bg-opacity-25 me-1"><i class="ri-arrow-down-line"></i> 7.00%</span>
                                                    <span>Since last month</span>
                                                </p>
                                            </div>
                                            <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-6">
                                                <div class="text-end">
                                                    <div id="campaign-sent-chart" data-colors="#4254ba"></div>
                                                </div>
                                            </div>
                                        </div> <!-- end row-->
                                    </div> <!-- end card-body -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-6">
                                                <div class="text-end">
                                                    <div id="new-leads-chart" data-colors="#17a497"></div>
                                                </div>
                                            </div>
                                        </div> <!-- end row-->
                                    </div> <!-- end card-body -->
